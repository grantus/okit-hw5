...
/** Manages client-side account operations and active sessions. */
public final class AccountManager {
  ...
  /**
   * Creates an account manager bound to authorization and account data sources.
   *
   * @param serv authorization source
   * @param serverAccountsData account data source
   * @throws OperationException if the manager cannot be initialized
   */
  ...
  /**
   * Returns encoded password representation.
   *
  ...
  /**
   * Registers a new account and stores it among active accounts on success.
   *
   * @param login user login
   * @param password user password
   * @return created account or {@code null} if registration failed
   */
  ...
  /**
   * Logs in an existing account and stores it among active accounts on success.
   *
   * @param login user login
   * @param password user password
   * @return logged in account or {@code null} if login failed
   */
  ...
  private OperationResponse callLogout(Account a) {
    if (a.getActiveSession() == Account.NO_SESSION) {
  ...
  /**
   * Returns collected operation exceptions.
   *
   * @return unmodifiable collection of registered exceptions
   */
